...
namespace MarketMVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,CustomerFirstName,CustomerLastName,PhoneNumber,Address,Email,Document,DocumentTypeID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,CustomerFirstName,CustomerLastName,PhoneNumber,Address,Email,Document,DocumentTypeID")] Customer customer)
        {
            if (ModelState.IsValid)
            {
